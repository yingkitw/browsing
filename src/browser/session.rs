...
impl Browser {
    ...
    pub async fn take_screenshot(
        ...
        let data_b64 = page.screenshot_with_options(format, quality, full_page, None).await?;
    ...
    pub async fn create_new_tab(&mut self, url: Option<&str>) -> Result<String> {
        ...
        let result = client
            .send_command("Target.createTarget", params)
            .await?;
    ...
    pub async fn get_current_page_title(&self) -> Result<String> {
        ...
        let target_info = client
            .send_command("Target.getTargetInfo", params)
            .await?;
    ...
    pub async fn get_browser_state_summary(
        ...
        let url = self.get_current_url().await.unwrap_or_else(|_| "about:blank".to_string());
        let title = self.get_current_page_title().await.unwrap_or_else(|_| "Unknown".to_string());
